...
import git.icyllite.twentyfour.datasources.subsonic.SubsonicClient
import git.icyllite.twentyfour.datasources.subsonic.models.AlbumID3
import git.icyllite.twentyfour.datasources.subsonic.models.ArtistID3
import git.icyllite.twentyfour.datasources.subsonic.models.Child
...
class SubsonicDataSource(
    ...
    private inner class SubsonicInstance(
        ...
        fun git.icyllite.twentyfour.datasources.subsonic.models.Genre.toMediaItem() =
            Genre.Builder(getGenreUri(value))
                .setName(value)
                .build()

        fun git.icyllite.twentyfour.datasources.subsonic.models.Playlist.toMediaItem() =
            Playlist.Builder(getPlaylistUri(id))
                .setName(name)
                .build()

        fun git.icyllite.twentyfour.datasources.subsonic.models.MediaType?.toAudioType() = when (
            this
        ) {
            git.icyllite.twentyfour.datasources.subsonic.models.MediaType.MUSIC -> Audio.Type.MUSIC
            git.icyllite.twentyfour.datasources.subsonic.models.MediaType.PODCAST -> Audio.Type.PODCAST
            git.icyllite.twentyfour.datasources.subsonic.models.MediaType.AUDIOBOOK -> Audio.Type.AUDIOBOOK
            git.icyllite.twentyfour.datasources.subsonic.models.MediaType.VIDEO -> throw Exception(
        ...
        fun git.icyllite.twentyfour.datasources.subsonic.models.LyricsList.toModel() =
