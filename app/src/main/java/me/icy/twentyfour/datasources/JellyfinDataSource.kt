...
import me.icy.twentyfour.datasources.jellyfin.JellyfinClient
import me.icy.twentyfour.datasources.jellyfin.models.Item
import me.icy.twentyfour.datasources.jellyfin.models.ItemType
...
class JellyfinDataSource(
    ...
    private fun me.icy.twentyfour.datasources.jellyfin.models.Lyrics.toModel() = lyrics?.let {
        Lyrics.Builder()
            .apply {
                it.forEach { lyrics ->
                    addLine(
